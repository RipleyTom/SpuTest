...
ppu-lv2-gcc -O3 spurs_helpers.c test_avalanche.c test_pingpong.c test_mfc64.c test_spu_inst.c main.c task.ppu.o task_pingpong.ppu.o task_mfc64.ppu.o task_spuint.ppu.o task_spufloat.ppu.o -lsysmodule_stub -lspurs_stub -o spurs_test.elf
